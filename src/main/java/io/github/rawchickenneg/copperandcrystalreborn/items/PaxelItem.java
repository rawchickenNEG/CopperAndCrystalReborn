...
public class PaxelItem extends DiggerItem {
    public PaxelItem(float attackDamageIn, float attackSpeedIn, Tier tier, TagKey<Block> mineable, Properties builder)
    {
        super(attackDamageIn, attackSpeedIn, tier, MineableTag.MINEABLE_WITH_PAXEL, builder);
    }
